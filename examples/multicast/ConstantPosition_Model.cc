...
static const std::string filename = "ConstantPosition_Model";
...
int main (int argc, char **argv)
{
  ...
  std::string input = "./examples/multicast/Line_4_Nodes_Interference.csv";

  uint32_t packetSize = 50;
  uint32_t numPackets = 100;
  uint32_t simEndTime = 100;

  uint32_t interferPacketSize = 50;
  uint32_t interferenceSendIntervall = 100;
  uint32_t sendIntervall = 1000;

...
{
  static TypeId tid = TypeId ("ns3::aodvIpv6::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::aodvIpv6::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvIpv6")
...
{
  static TypeId tid = TypeId ("ns3::aodvIpv6::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvIpv6")
...
{
  static TypeId tid = TypeId ("ns3::aodvIpv6::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvIpv6")
...
{
  static TypeId tid = TypeId ("ns3::aodvIpv6::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvIpv6")

...
NS_LOG_COMPONENT_DEFINE ("AodvIpv6Neighbors");
...
void
Neighbors::AddArpCache (Ptr<NdiscCache> a)
{
  m_arp.push_back (a);
}

void
Neighbors::DelArpCache (Ptr<NdiscCache> a)
{
...
{
  Mac48Address hwaddr;
  for (std::vector<Ptr<NdiscCache> >::const_iterator i = m_arp.begin ();
       i != m_arp.end (); ++i)
    {

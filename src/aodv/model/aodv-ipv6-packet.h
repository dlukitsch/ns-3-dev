 ...
 */
#ifndef AODV_IPV6_PACKET_H
#define AODV_IPV6_PACKET_H
...
enum MessageType
{
  AODVTYPE_RREQ  = 16,   //!< AODVTYPE_RREQ
  AODVTYPE_RREP  = 17,   //!< AODVTYPE_RREP
  AODVTYPE_RERR  = 18,   //!< AODVTYPE_RERR
  AODVTYPE_RREP_ACK = 19 //!< AODVTYPE_RREP_ACK
};
...
* \brief   Route Request (RREQ) Message Format
  \verbatim
  0                   1                   2                   3
  0 1 2 3 6 5 6 7 8 9 0 1 2 3 6 5 6 7 8 9 0 1 2 3 6 5 6 7 8 9 0 1
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
* \brief Route Reply Acknowledgment (RREP-ACK) Message Format
  \verbatim
  0                   1
  0 1 2 3 6 5 6 7 8 9 0 1 2 3 6 5
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |     Type      |   Reserved    |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  \endverbatim
...
public:
   ...
   * \param dst unreachable IPv6 address

 ...
 */
#ifndef AODV_IPV6_ROUTINGPROTOCOL_H
#define AODV_IPV6_ROUTINGPROTOCOL_H

#include "aodv-ipv6-rtable.h"
#include "aodv-ipv6-rqueue.h"
#include "aodv-ipv6-packet.h"
#include "aodv-ipv6-neighbor.h"
#include "aodv-ipv6-dpd.h"
#include "ns3/node.h"
...
private:
   ...
   */ 
  bool Forwarding (int32_t iif, Ptr<const Packet> p, const Ipv6Header & header, UnicastForwardCallback ucb, ErrorCallback ecb);
  /**
...
#endif /* AODV_IPV6_ROUTINGPROTOCOL_H */

...
sim_data = pd.read_csv("../output/Line_10_Interference_5ms_Mpl_2D2C/results/results_1.csv")
...
ax1.set(xlabel='X-Coordinate [m]', ylabel='Y-Coordinate [m]', title= "MPL 2D2C with Interference")
...
ax1.figure.savefig("scatterplot_Intererence_Line_2D2C.pdf", bbox_inches='tight', dpi=300)

...
sim_data = pd.read_csv("../output/Line_10_Interference_5ms_Mpl_2D1C/results/results_1.csv")
...
ax1 = sns.scatterplot(data=sim_data, x ='x', y = 'y', hue = "PDR [%]", size = "# Sent Packets", sizes=(50,500), hue_norm = (0, 100), size_norm = (0, 130), legend=True, linewidth=0, palette =pal)
...
ax1.figure.savefig("scatterplot_Intererence_Line_2D1C.pdf", bbox_inches='tight', dpi=300)

...
sim_data = pd.read_csv("../output/Circle_10_Flooding/results_median.csv")
...
for line in range(0, 1):
     h.text(sim_data['x'][line]-17, sim_data['y'][line]+20, "Sender", horizontalalignment='left', size='small', color='black')
...
h.figure.savefig("scatterplot_Circle_10_Flooding.pdf",bbox_inches='tight', dpi=300)

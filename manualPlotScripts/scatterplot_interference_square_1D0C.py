...
sim_data = pd.read_csv("../output/Square_5x5_Interference_5ms_Mpl_1D0C/results_mean.csv")
...
ax1 = sns.scatterplot(data=sim_data, x ='x', y = 'y', hue = "PDR [%]", size = "# Sent Packets", sizes=(50,500), hue_norm = (0, 500), size_norm = (40, 120), legend=True, linewidth=0, palette =pal)
...
ax1.set(xlabel='X-Coordinate [m]', ylabel='Y-Coordinate [m]', title= "MPL 1D0C with Interference")
...
ax1.figure.savefig("scatterplot_Intererence_Square_1D0C.svg",  dpi=1200)
...
tail -n +2 $SIM_FILE | 
    ...
    proactiveForwarding reactiveForwarding seedSetEntryLifetime dataMessageIMin dataMessageIMax dataMessageK dataMessageTimerExpirations controlMessageIMin controlMessageIMax controlMessageK controlMessageTimerExpirations numHops ; do
      ...
      python3 ./contrib/statistics/model/printDiagsCsvIntern.py -i $SCRIPT_DIR/output/${simName}/${simName}.csv -o $SCRIPT_DIR/output/${simName}/${simName}
    done
...
tail -n +2 $COMAPRE_DIAGS |
    while read outname diagType diagValue title xDescription yDescription dataFile1 legend1 dataFile2 legend2 dataFile3 legend3 dataFile4 legend4 dataFile5 legend5 dataFile6 legend6 ; do
      ...
      [ -z $dataFile1 ] && unset DATA_FILE1 || DATA_FILE1=" -a $SCRIPT_DIR/output/${dataFile1}/${dataFile1}.csv"
      [ -z $dataFile2 ] && unset DATA_FILE2 || DATA_FILE2=" -b $SCRIPT_DIR/output/${dataFile2}/${dataFile2}.csv"
      [ -z $dataFile3 ] && unset DATA_FILE3 || DATA_FILE3=" -c $SCRIPT_DIR/output/${dataFile3}/${dataFile3}.csv"
      [ -z $dataFile4 ] && unset DATA_FILE4 || DATA_FILE4=" -d $SCRIPT_DIR/output/${dataFile4}/${dataFile4}.csv"
      [ -z $dataFile5 ] && unset DATA_FILE5 || DATA_FILE5=" -e $SCRIPT_DIR/output/${dataFile5}/${dataFile5}.csv"
      [ -z $dataFile6 ] && unset DATA_FILE6 || DATA_FILE6=" -f $SCRIPT_DIR/output/${dataFile6}/${dataFile6}.csv"
